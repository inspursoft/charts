...
{{ printf "%s && %s" .Values.jobmanager.additionalCommand (tpl .Values.jobmanager.highAvailability.command .) }}
{{- else }}
{{ printf "%s && %s" .Values.jobmanager.additionalCommand .Values.jobmanager.command }}
{{- end }}
{{- else }}
{{- if .Values.jobmanager.highAvailability.enabled }}
{{ tpl .Values.jobmanager.highAvailability.command . }}
{{- else }}
{{ .Values.jobmanager.command }}
{{- end -}}
{{- end -}}
{{- end -}}
